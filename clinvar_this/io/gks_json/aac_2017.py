...
Currently only supports Therapeutic and Diagnostic Assertions. This assumes you
...
class Aac2017GksJsonTransformer(GksJsonTransformer):
    ...
    def _get_clinical_impact_submission(
        ...
        """Get clinical impact submission for a therapeutic or diagnostic assertion
        ...
        :param record: The therapeutic or diagnostic assertion
        ...
        :return: The clinical impact submission for a therapeutic or diagnostic
            assertion
        """
    ...
    def records_to_submission_container(
        ...
        :param study_statements: List of Therapeutic Response or Diagnostic
            Assertions represented as GKS Variant Therapeutic Response or Diagnostic
            Study Statements
